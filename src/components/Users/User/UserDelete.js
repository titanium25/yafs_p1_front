    ...
    return (
        <div>
            ...
            <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
                ...
                <DialogContent>
                    <DialogContentText>
                        This action cannot be undone. This will permanently delete the <b>{props.user.username}</b> from
                        the database. <br/>
                        Please type <b>delete {props.user.username}</b> to confirm.
                    </DialogContentText>
                    <TextField
                        autoFocus
                        margin="dense"
                ...
                <DialogActions>
                    ...
                    {
                        text === 'delete ' + props.user.username ?
